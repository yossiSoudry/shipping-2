...
const Content = () => {
  return (
    <section className="w-full flex font-heebo mt-20">
      <div className="z-10">
        <div className="w-[600px] h-[600px] relative">
          ...
          />
          <div className="absolute top-[240px] right-0 w-[286px] h-[286px]">
            <div className="absolute right-[420px] rounded-[52px] bg-bisque border-white border-[15px] w-[286px] h-[286px] flex items-center justify-center">
              <Image
      ...
      <div className="flex-1 flex flex-col gap-16 pt-16 pr-16">
        ...
        <div className="text-steelblue-200 pr-16 leading-relaxed">
